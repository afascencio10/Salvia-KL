// Package salvia_facades — CasosEntidadFacade: pantalla Casos Entidad (solo rol et).
...
// CasosEntidadGET renderiza la pantalla "Casos Entidad".
func CasosEntidadGET(c *gin.Context) {
	...
	if !utils.CheckPermission(salvia_config.PermissionsByRole, "get_casos_entidad", s.CurrentRole, c) {
		return
	}

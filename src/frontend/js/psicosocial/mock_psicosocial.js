    ...
    PRIMERA_ATENCION: [
      {
        ...
        questions: [
          ...
          { label: '¿Es atención o solo contacto?',                       type: 'single', options: ['Atención', 'Solo Contacto'], highlight: true, note: 'GATILLO S2: "Solo Contacto" oculta la sección siguiente' },
    ...
    CIERRE: [
      {
        ...
        questions: [
          ...
          { label: 'Descripción de los hechos',                            type: 'text',     conditional: 'Si Q5 = Sí' },
          { label: 'Fecha de los hechos',                                  type: 'date',     conditional: 'Si Q5 = Sí' },
          { label: '¿Es atención o solo contacto?',                       type: 'single', options: ['Atención', 'Solo Contacto'], highlight: true, note: 'GATILLO S2: "Solo Contacto" oculta las secciones 2 y 3' },
          { label: 'Observaciones del contacto',                           type: 'text' },
          { label: 'Fecha nueva',                                          type: 'date',     conditional: 'Si Q8 = Solo Contacto' },
        ],
      },

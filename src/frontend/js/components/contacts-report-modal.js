app.component('contacts-report-modal', {
    template: window.__contactsReportModalTpl || '#tpl-contacts-report-modal',
    delimiters: ['${', '}'],
    props: {
        currentRole: {
            type: String,
    ...
    methods: {
        ...
        startProgressTimer: function() {
            ...
            this.progressInterval = setInterval(() => {
                ...
                if (this.elapsedSeconds <= 3) {
                    ...
                    this.progressMessage = 'Escribiendo registros en la hoja de cálculo...';
        ...
        submitReport: function() {
            ...
            // Validaciones locales (espejan al backend)
            ...
            fetch('/api/v1/reportes/contactos-consolidado', {
                method: 'POST',
                headers: {
            ...
            .then(blob => {
                ...
                a.href = url;
                a.download = `reporte-contactos_${this.startDate}_${this.endDate}.xlsx`;

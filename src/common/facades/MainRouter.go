...
func AuthMiddleware() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if !strings.Contains(location, publicURI) && !strings.Contains(location, staticURI) && !IsLoggedIn(c) && !strings.Contains(location, "login") && !strings.HasPrefix(location, "/api/") {
